...
namespace Cryptomkt\Curl;

use Cryptomkt\Curl\ArrayUtil;
use Cryptomkt\Curl\Decoder;
...
class Curl
{
    ...
    {
        $this->jsonDecoder = '\Cryptomkt\Curl\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = '\Cryptomkt\Curl\Decoder::decodeXml';
    ...
    public function setDefaultDecoder($mixed = 'json')
    {
        if ($mixed === false) {
            ...
            if ($mixed === 'json') {
                $this->defaultDecoder = '\Cryptomkt\Curl\Decoder::decodeJson';
            } elseif ($mixed === 'xml') {
                $this->defaultDecoder = '\Cryptomkt\Curl\Decoder::decodeXml';
            }
        }
    }
     ...
     * @param  $raw_headers
     *
     * @return \Cryptomkt\Curl\CaseInsensitiveArray
     */
