...
class Mapper
{
    ...
    // markets
    public function toMarket($response, Market $market = null){
        return $this->toCollection($response, 'injectMarket');
    }

    // tickers
    public function toTicker( $response, Ticker $ticker = null){
    ...
    /** @return User */
    public function toUser( $response, User $user = null)
    {
    ...
    public function toAccounts( $response)
    {
        return $this->toCollection($response, 'injectAccount');
    }

    /** @return Account */
    public function toAccount( $response, Account $account = null)
    {
    ...
    /** @return ResourceCollection */
    public function toAddresses( $response)
    {
        return $this->toCollection($response, 'injectAddress');
    }

    /** @return Address */
    public function toAddress( $response, Address $address = null)
    {
    ...
    /** @return ResourceCollection */
    public function toTransactions( $response)
    {
        return $this->toCollection($response, 'injectTransaction');
    }

    /** @return Transaction */
    public function toTransaction( $response, Transaction $transaction = null)
    {
    ...
    public function fromTransaction(Transaction $transaction)
    {
        ...
        if ($to && !$to instanceof Email && !$to instanceof BitcoinAddress && !$to instanceof Account) {
            throw new LogicException(
                'The CryptoMarket API only accepts transactions to an account, email, or bitcoin address'
            );
        }
    ...
    /** @return ResourceCollection */
    public function toBuys( $response)
    {
        return $this->toCollection($response, 'injectBuy');
    }

    /** @return Buy */
    public function toBuy( $response, Buy $buy = null)
    {
    ...
    public function fromBuy(Buy $buy)
    {
        ...
        if ($buy->getAmount() && $buy->getTotal()) {
            throw new LogicException(
                'The CryptoMarket API accepts buys with either an amount or a total, but not both'
            );
        }
    ...
    /** @return ResourceCollection */
    public function toSells( $response)
    {
        return $this->toCollection($response, 'injectSell');
    }

    /** @return Sell */
    public function toSell( $response, Sell $sell = null)
    {
    ...
    public function fromSell(Sell $sell)
    {
        ...
        if ($sell->getAmount() && $sell->getTotal()) {
            throw new LogicException(
                'The CryptoMarket API accepts sells with either an amount or a total, but not both'
            );
        }
    ...
    /** @return ResourceCollection */
    public function toDeposits( $response)
    {
        return $this->toCollection($response, 'injectDeposit');
    }

    /** @return Deposit */
    public function toDeposit( $response, Deposit $deposit = null)
    {
    ...
    /** @return ResourceCollection */
    public function toWithdrawals( $response)
    {
        return $this->toCollection($response, 'injectWithdrawal');
    }

    /** @return Withdrawal */
    public function toWithdrawal( $response, Withdrawal $withdrawal = null)
    {
    ...
    /** @return ResourceCollection */
    public function toPaymentMethods( $response)
    {
        return $this->toCollection($response, 'injectPaymentMethod');
    }

    /** @return PaymentMethod */
    public function toPaymentMethod( $response, PaymentMethod $paymentMethod = null)
    {
    ...
    /** @return Merchant */
    public function toMerchant( $response, Merchant $merchant = null)
    {
    ...
    /** @return ResourceCollection */
    public function toOrders( $response)
    {
        return $this->toCollection($response, 'injectOrder');
    }

    /** @return Order */
    public function toOrder( $response, Order $order = null)
    {
    ...
    /** @return ResourceCollection */
    public function toCheckouts( $response)
    {
        return $this->toCollection($response, 'injectCheckout');
    }

    /** @return Checkout */
    public function toCheckout( $response, Checkout $checkout = null)
    {
    ...
    /** @return ResourceCollection */
    public function toNotifications( $response)
    {
        return $this->toCollection($response, 'injectNotification');
    }

    /** @return Notification */
    public function toNotification( $response, Notification $notification = null)
    {
    ...
    /** @return array */
    public function toData( $response)
    {
        return $response;
    }

    /** @return Money|null */
    public function toMoney( $response)
    {
    ...
    private function toCollection( $response, $method)
    {
